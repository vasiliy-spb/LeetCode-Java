...
public class Solution17 {
    public int[] resultsArray(int[] nums, int k) {
        ...
        // Step 1: Calculate DP array to check for consecutiveness
        for (int i = 1; i < n; i++) {
        ...
        // Step 2: Use sliding window to compute results
        for (int i = 0; i < n; i++) {
            // Maintain deque for the maximum element
